...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-8 left-0 w-full z-50 flex justify-center px-4 pointer-events-none">
      ...
      >
        {/* 3D Glass Layering */}
        <div style={{ transform: "translateZ(10px)" }} className="flex items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
          {/* Title / Glass Layer */}
          <div
          ...
          {/* Links */}
          <div className="flex gap-4 sm:gap-6 md:gap-8 items-center mr-6 sm:mr-8 md:mr-10">
          ...
          <button
            ...
            className="px-2 sm:px-3 py-1 rounded-full bg-white text-black text-[9px] sm:text-xs md:text-sm font-semibold transition-transform hover:scale-105 active:scale-95 whitespace-nowrap -ml-8 sm:-ml-4"
          >
            Let's Connect
          </button>
        </div>
