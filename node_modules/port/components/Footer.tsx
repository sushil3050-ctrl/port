...
export default function Footer() {
    return (
        <footer id="contact" className="relative z-30 w-full py-8 md:py-12 px-6 border-t border-white/5 bg-white/[0.02] backdrop-blur-xl">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
                <div className="flex flex-col items-center md:items-start gap-2 text-center md:text-left">
                    <h3 className="text-lg md:text-xl font-bold bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent">
                        Sush!l RK
                    </h3>
                ...
                <div className="text-xs md:text-sm text-gray-600 text-center md:text-right cursor-none" >
